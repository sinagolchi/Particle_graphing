...
class data_set():
    ...
    def plot_all(self):
        handles = []
        self.colors = (c for c in ['#e6194b', '#3cb44b', '#f58231', '#4363d8', '#f58231', '#911eb4', '#46f0f0', '#f032e6'])
        self.markers = (m for m in ['v','s','o','d'])
        self.offset = (t for t in [-1,0,1,1,1.5])
        self.num_keys1 = (k for k in range(1,10))
        self.num_keys2 = (k for k in range(10,25))
        self.check_keys = (k for k in range(25,50))
